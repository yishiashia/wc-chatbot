...
describe('Chatbot web component', () => {
  ...
  test('scroll to bottom', async () => {
    ...
    const propertyDescriptor = Object.getOwnPropertyDescriptor(Element.prototype, 'scrollTo');
  ...
  test('send HTML message', () => {
    chatbot.sendMessage(null, { message: '<p id="test-p">hello <a id="test-a" href="http://example.org">123</a></p>' });
